...
internal static class SPACalculator
{
    public struct SPAData
    {
        //----------------------INPUT VALUES------------------------

        public required int Year; // 4-digit year,      valid range: -2000 to 6000, error code: 1
        public required int Month; // 2-digit month,         valid range: 1 to  12,  error code: 2
        public required int Day; // 2-digit day,           valid range: 1 to  31,  error code: 3
        public required int Hour; // Observer local hour,   valid range: 0 to  24,  error code: 4
        public required int Minute; // Observer local minute, valid range: 0 to  59,  error code: 5
        public required double Second; // Observer local second, valid range: 0 to <60,  error code: 6

        public required double DeltaUt1; // Fractional second difference between UTC and UT which is used
        ...
        public required double DeltaT; // Difference between earth rotation time and terrestrial time
        ...
        public required double Temperature; // Annual average local temperature [degrees Celsius]
        ...
        public required double AtmosRefract; // Atmospheric refraction at sunrise and sunset (0.5667 deg is typical)
        // valid range: -5   to   5 degrees, error code: 16

        public required CalculationMode Function; // Switch to choose functions for desired output (from enumeration)
    ...
    static double SunHourAngleAtRiseSet(double latitude, double deltaZero, double h0Prime)
    {
        ...
        {
            h0 = LimitDegrees180(RadToDeg(Math.Acos(argument)));
        }
