...
/// </summary>
internal sealed class NoradSDP4 : NoradBase
{
    private const double zns = 1.19459E-5;
    private const double zes = 0.01675;
    private const double znl = 1.5835218E-4;
    private const double zel = 0.05490;
    private const double thdt = 4.3752691E-3;
    private readonly double dp_e3;
    private readonly double dp_ee2;
    private readonly double dp_se2;
    private readonly double dp_se3;
    private readonly double dp_sgh2;
    private readonly double dp_sgh3;
    private readonly double dp_sgh4;
    private readonly double dp_sh2;
    private readonly double dp_sh3;
    private readonly double dp_si2;
    private readonly double dp_si3;
    private readonly double dp_sl2;
    private readonly double dp_sl3;
    private readonly double dp_sl4;
    private readonly double dp_xgh2;
    private readonly double dp_xgh3;
    private readonly double dp_xgh4;
    private readonly double dp_xh2;
    private readonly double dp_xh3;
    private readonly double dp_xi2;
    private readonly double dp_xi3;
    private readonly double dp_xl2;
    private readonly double dp_xl3;
    private readonly double dp_xl4;
    private readonly double dp_xqncl;
    private readonly double dp_zmol;
    private readonly double dp_zmos;
    private double dp_atime;
    private readonly double dp_d2201;
    private readonly double dp_d2211;
    private readonly double dp_d3210;
    private readonly double dp_d3222;
    private readonly double dp_d4410;
    private readonly double dp_d4422;
    private readonly double dp_d5220;
    private readonly double dp_d5232;
    private readonly double dp_d5421;
    private readonly double dp_d5433;
    private readonly double dp_del1;
    private readonly double dp_del2;
    private readonly double dp_del3;
    private readonly double dp_omegaq;
    private readonly double dp_sse;
    private readonly double dp_ssg;
    private readonly double dp_ssh;
    private readonly double dp_ssi;
    private readonly double dp_ssl;
    private readonly double dp_step2;
    private readonly double dp_stepn;
    private readonly double dp_stepp;
    private readonly double dp_thgr;
    private readonly double dp_xfact;
    private readonly double dp_xlamo;
    private double dp_xli;
    private double dp_xni;
    private readonly bool gp_reso;  // geopotential resonant
    private readonly bool gp_sync;  // geopotential synchronous
       ...
       base(orbit)
    {
        ...
        if (Orbit.MeanMotion is > 0.0034906585 and < 0.0052359877)
        {
        ...
        else if ((Orbit.MeanMotion >= 8.26E-3) && (Orbit.MeanMotion <= 9.24E-3) && (eq >= 0.5))
        {
            ...
            else
            {
                ...
                g520 = eq <= 0.715 ? 1464.74 - (4664.75 * eq) + (3763.64 * eosq) : -5149.66 + (29936.92 * eq) - (54087.36 * eosq) + (31324.56 * eoc);
            }
    ...
    /// orbit model.
    /// </remarks>
    public override OrbitalState<double> GetPosition(double tsince)
    {
        ...
        double a = Math.Pow(Xke / xn, 2.0 / 3.0) * Globals.Sqr(tempa);
        double e = em - tempe;
