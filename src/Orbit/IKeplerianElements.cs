...
public interface IKeplerianElements<T> where T : INumber<T>, IFloatingPoint<T>
{
    ...
    /// </summary>
    public Angle<T> Inclination { get; }
    ...
    /// </summary>
    public Angle<T> RightAscensionOfAscendingNode { get; }
    ...
    /// </summary>
    public Angle<T> MeanAnomaly { get; }
    ...
    /// </summary>
    public Angle<T> ArgumentOfPeriapsis { get; }
